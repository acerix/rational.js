...
rat.traceSternBrocot=function(a){var b="";if(rat.equals(a,rat.ZERO)||rat.equals(a,rat.ONE)||rat.equals(a,rat.INFINITY)||rat.equals(a,rat.INFINULL))return b;a=rat.clone(a);rat.isNegative(a)&&(a[0]=-a[0]);for(var c=rat.clone(rat.ONE),d=[1,0,0,1],e=0,f=0,h=rat.MAX_LOOPS;!rat.approximates(a,c)&&h--;)rat.isLessThan(a,c)?(d[0]+=d[1],d[2]+=d[3],f++,e&&(b+="R",1!==e&&(b+=e),e=0,b+=" ")):(d[1]+=d[0],d[3]+=d[2],e++,f&&(b+="L",1!==f&&(b+=f),f=0,b+=" ")),c[0]=d[0]+d[1],c[1]=d[2]+d[3];f?(b+="L",1!==f&&(b+=f)):
e&&(b+="R",1!==e&&(b+=e));0>h&&(b+="...");return b};
